...
public sealed class DualBuster : DeltaruneActsCard
{
    ...
    {
        if (cardPlay.Target is null || cardPlay.Target.IsDead) return;
        await DamageCmd.Attack(100).FromCard(this, cardPlay).Targeting(cardPlay.Target).Execute(choiceContext);
    }
}
